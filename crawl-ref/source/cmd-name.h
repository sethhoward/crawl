...
{CMD_FIRE_ITEM_NO_QUIVER, "CMD_FIRE_ITEM_NO_QUIVER"},
...
{CMD_EXPLORE_NO_REST, "CMD_EXPLORE_NO_REST"},
...
#endif
#ifdef __ANDROID__
{CMD_TOGGLE_TAB_ICONS, "CMD_TOGGLE_TAB_ICONS"},
{CMD_TOGGLE_KEYBOARD, "CMD_TOGGLE_KEYBOARD"},
#endif
{CMD_PREV_CMD_AGAIN, "CMD_PREV_CMD_AGAIN"},
{CMD_REPEAT_CMD, "CMD_REPEAT_CMD"},
{CMD_SHOW_CHARACTER_DUMP, "CMD_SHOW_CHARACTER_DUMP"},
{CMD_GAME_MENU, "CMD_GAME_MENU"},
#ifdef TARGET_OS_MACOSX
{CMD_REVEAL_OPTIONS, "CMD_REVEAL_OPTIONS"},
#endif
...
{CMD_MENU_UP, "CMD_MENU_UP"},
{CMD_MENU_DOWN, "CMD_MENU_DOWN"},
{CMD_MENU_LEFT, "CMD_MENU_LEFT"},
{CMD_MENU_RIGHT, "CMD_MENU_RIGHT"},
{CMD_MENU_LINE_UP, "CMD_MENU_LINE_UP"},
{CMD_MENU_LINE_DOWN, "CMD_MENU_LINE_DOWN"},
{CMD_MENU_PAGE_UP, "CMD_MENU_PAGE_UP"},
{CMD_MENU_PAGE_DOWN, "CMD_MENU_PAGE_DOWN"},
{CMD_MENU_SCROLL_TO_TOP, "CMD_MENU_SCROLL_TO_TOP"},
{CMD_MENU_SCROLL_TO_END, "CMD_MENU_SCROLL_TO_END"},
{CMD_MENU_SEARCH, "CMD_MENU_SEARCH"},
{CMD_MENU_CYCLE_MODE, "CMD_MENU_CYCLE_MODE"},
{CMD_MENU_CYCLE_MODE_REVERSE, "CMD_MENU_CYCLE_MODE_REVERSE"},
{CMD_MENU_CYCLE_HEADERS, "CMD_MENU_CYCLE_HEADERS"},
{CMD_MENU_HELP, "CMD_MENU_HELP"},
{CMD_MENU_SELECT, "CMD_MENU_SELECT"},
{CMD_MENU_EXAMINE, "CMD_MENU_EXAMINE"},
{CMD_MENU_EXIT, "CMD_MENU_EXIT"},
{CMD_MENU_ACCEPT_SELECTION, "CMD_MENU_ACCEPT_SELECTION"},
{CMD_MENU_SELECT_ALL, "CMD_MENU_SELECT_ALL"},
{CMD_MENU_CLEAR_SELECTION, "CMD_MENU_CLEAR_SELECTION"},
{CMD_MENU_INVERT_SELECTION, "CMD_MENU_INVERT_SELECTION"},
{CMD_MENU_TOGGLE_SELECTED, "CMD_MENU_TOGGLE_SELECTED"},
#ifdef USE_TILE
