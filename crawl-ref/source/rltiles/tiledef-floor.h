...
enum tile_floor_type
{
    ...
    TILE_FLOOR_VAULT_2,
    TILE_FLOOR_VAULT_3,
    TILE_FLOOR_METAL_SILVER,
    TILE_FLOOR_METAL_SILVER_1,
    TILE_FLOOR_METAL_SILVER_2,
    TILE_FLOOR_METAL_SILVER_3,
    TILE_FLOOR_METAL_GOLD,
    TILE_FLOOR_METAL_GOLD_1,
    TILE_FLOOR_METAL_GOLD_2,
    TILE_FLOOR_METAL_GOLD_3,
    TILE_FLOOR_METAL_INFERNAL,
    TILE_FLOOR_METAL_INFERNAL_1,
    TILE_FLOOR_METAL_INFERNAL_2,
    TILE_FLOOR_METAL_INFERNAL_3,
    TILE_FLOOR_CRYSTAL,
    TILE_FLOOR_CRYSTAL_1,
    TILE_FLOOR_CRYSTAL_2,
    TILE_FLOOR_CRYSTAL_3,
    ...
    TILE_FLOOR_MYSTIC_CHASM,
    TILE_FLOOR_MYSTIC_CHASM_1,
    TILE_FLOOR_MYSTIC_CHASM_2,
    TILE_FLOOR_MYSTIC_CHASM_3,
    TILE_FLOOR_MYSTIC_CHASM_4,
    TILE_FLOOR_MYSTIC_CHASM_5,
    TILE_FLOOR_MYSTIC_CHASM_6,
    TILE_FLOOR_MYSTIC_CHASM_7,
    TILE_FLOOR_GRASS,
    TILE_FLOOR_GRASS_1,
    TILE_FLOOR_GRASS_2,
    TILE_FLOOR_GRASS_3,
    ...
    TILE_FLOOR_GRASS_10,
    TILE_FLOOR_GRASS_11,
    TILE_FLOOR_GRASS_DARK,
    TILE_FLOOR_GRASS_DARK_1,
    TILE_FLOOR_GRASS_DARK_2,
    TILE_FLOOR_GRASS_DARK_3,
    TILE_FLOOR_GRASS_DARK_4,
    TILE_FLOOR_GRASS_DARK_5,
    TILE_FLOOR_GRASS_DARK_6,
    TILE_FLOOR_GRASS_DARK_7,
    TILE_FLOOR_GRASS_DARK_8,
    TILE_FLOOR_GRASS_DARK_9,
    TILE_FLOOR_GRASS_DARK_10,
    TILE_FLOOR_GRASS_DARK_11,
    TILE_HALO_GRASS,
    TILE_HALO_GRASS_1,
    TILE_HALO_GRASS_2,
    TILE_HALO_GRASS_3,
    ...
    TILE_HALO_GRASS_7,
    TILE_HALO_GRASS_8,
    TILE_FLOOR_SPROUTING_STONE,
    TILE_FLOOR_SPROUTING_STONE_1,
    TILE_FLOOR_SPROUTING_STONE_2,
    TILE_FLOOR_SPROUTING_STONE_3,
    TILE_FLOOR_SPROUTING_STONE_4,
    TILE_FLOOR_SPROUTING_STONE_5,
    TILE_FLOOR_SPROUTING_STONE_6,
    TILE_FLOOR_SPROUTING_STONE_7,
    TILE_FLOOR_SPROUTING_STONE_8,
    TILE_FLOOR_SPROUTING_STONE_9,
    TILE_FLOOR_SPROUTING_STONE_10,
    TILE_FLOOR_SPROUTING_STONE_11,
    TILE_FLOOR_SPROUTING_SQUARES,
    TILE_FLOOR_SPROUTING_SQUARES_1,
    TILE_FLOOR_SPROUTING_SQUARES_2,
    TILE_FLOOR_SPROUTING_SQUARES_3,
    TILE_FLOOR_SPROUTING_SQUARES_4,
    TILE_FLOOR_SPROUTING_SQUARES_5,
    TILE_FLOOR_SPROUTING_SQUARES_6,
    TILE_FLOOR_SPROUTING_SQUARES_7,
    TILE_FLOOR_SPROUTING_SQUARES_8,
    TILE_FLOOR_SPROUTING_SQUARES_9,
    TILE_FLOOR_SPROUTING_SQUARES_10,
    TILE_FLOOR_SPROUTING_SQUARES_11,
    TILE_FLOOR_SPROUTING_RUIN,
    TILE_FLOOR_SPROUTING_RUIN_1,
    TILE_FLOOR_SPROUTING_RUIN_2,
    TILE_FLOOR_SPROUTING_RUIN_3,
    TILE_FLOOR_SPROUTING_RUIN_4,
    TILE_FLOOR_SPROUTING_RUIN_5,
    TILE_FLOOR_SPROUTING_RUIN_6,
    TILE_FLOOR_SPROUTING_RUIN_7,
    TILE_FLOOR_SPROUTING_RUIN_8,
    TILE_FLOOR_SPROUTING_RUIN_9,
    TILE_FLOOR_SPROUTING_RUIN_10,
    TILE_FLOOR_SPROUTING_RUIN_11,
    TILE_FLOOR_NERVES,
    ...
    TILE_FLOOR_CRYPT_8,
    TILE_FLOOR_CRYPT_9,
    TILE_FLOOR_ZOT_DIAMONDS,
    TILE_FLOOR_ZOT_DIAMONDS_1,
    TILE_FLOOR_ZOT_DIAMONDS_2,
    TILE_FLOOR_ZOT_DIAMONDS_3,
    TILE_FLOOR_ZOT_DIAMONDS_4,
    TILE_FLOOR_ZOT_DIAMONDS_5,
    TILE_FLOOR_ZOT_DIAMONDS_6,
    TILE_FLOOR_ZOT_DIAMONDS_7,
    TILE_FLOOR_IRON,
    TILE_FLOOR_IRON_1,
    TILE_FLOOR_IRON_2,
    TILE_FLOOR_IRON_3,
    ...
    TILE_FLOOR_SEISMOROCK,
    TILE_FLOOR_SEISMOROCK_1,
    TILE_FLOOR_SEISMOROCK_2,
    TILE_FLOOR_SEISMOROCK_3,
    TILE_FLOOR_DEMONIC,
    ...
    TILE_FLOOR_NECROPOLIS_SQUARES,
    TILE_FLOOR_NECROPOLIS_SQUARES_1,
    TILE_FLOOR_NECROPOLIS_SQUARES_2,
    TILE_FLOOR_NECROPOLIS_SQUARES_3,
    TILE_FLOOR_NECROPOLIS_SQUARE_GRASS,
    TILE_FLOOR_NECROPOLIS_SQUARE_GRASS_1,
    TILE_FLOOR_NECROPOLIS_SQUARE_GRASS_2,
    TILE_FLOOR_NECROPOLIS_SQUARE_GRASS_3,
    TILE_FLOOR_NECROPOLIS_GRASS,
    TILE_FLOOR_NECROPOLIS_GRASS_1,
    TILE_FLOOR_NECROPOLIS_GRASS_2,
    TILE_FLOOR_NECROPOLIS_GRASS_3,
    TILE_FLOOR_STUDIO,
    TILE_FLOOR_STUDIO_1,
    TILE_FLOOR_STUDIO_2,
    TILE_FLOOR_STUDIO_3,
    ...
    TILE_DNGN_STARWATER,
    TILE_DNGN_STARWATER_1,
    TILE_DNGN_STARWATER_2,
    TILE_DNGN_STARWATER_3,
    TILE_DNGN_STARWATER_4,
    TILE_DNGN_STARWATER_5,
    TILE_DNGN_STARWATER_6,
    TILE_DNGN_STARWATER_7,
    TILE_DNGN_STARWATER_8,
    TILE_DNGN_STARWATER_9,
    TILE_DNGN_STARWATER_10,
    TILE_DNGN_STARWATER_11,
    TILE_DNGN_TOXIC_BOG,
    TILE_DNGN_TOXIC_BOG_1,
    TILE_DNGN_TOXIC_BOG_2,
    TILE_DNGN_TOXIC_BOG_3,
    TILE_DNGN_TOXIC_BOG_4,
    TILE_DNGN_TOXIC_BOG_5,
    TILE_DNGN_TOXIC_BOG_6,
    TILE_DNGN_TOXIC_BOG_7,
    TILE_SHORE_N,
    TILE_SHORE_W,
    TILE_SHORE_E,
    TILE_SHORE_NW,
