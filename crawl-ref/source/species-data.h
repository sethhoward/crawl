...
{  SP_NAGA,
    ...
    SPF_BARDING | SPF_NO_FEET | SPF_SMALL_TORSO,
    0, 2, 0, 5,
    MONS_NAGA,
...
{  SP_OCTOPODE,
    ...
    SPF_NO_EARS | SPF_NO_HAIR | SPF_NO_FEET | SPF_NO_BONES,
    0, -1, 0, 3,
    MONS_OCTOPODE,
    HT_WATER, US_ALIVE, SIZE_MEDIUM,
    7, 10, 7,
...
{  SP_POLTERGEIST,
    ...
    SPF_NO_HAIR | SPF_NO_BLOOD | SPF_NO_EARS | SPF_NO_FEET | SPF_NO_BONES,
    0, -1, 0, 4,
    MONS_POLTERGEIST,
    HT_LAND, US_UNDEAD, SIZE_MEDIUM,
    4, 10, 9,
...
{  SP_REVENANT,
    ...
    SPF_NO_BLOOD | SPF_NO_HAIR | SPF_NO_EARS,
    -1, 1, 1, 3,
    MONS_REVENANT,
    HT_LAND, US_UNDEAD, SIZE_MEDIUM,
    11, 7, 4,
